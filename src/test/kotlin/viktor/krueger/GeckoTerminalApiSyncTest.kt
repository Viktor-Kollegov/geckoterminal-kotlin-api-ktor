...
class GeckoTerminalApiSyncTest {
    private val api = GeckoTerminalApiSync()

    @Test
    fun testGetSimpleTokenPrices() {
        val network = "eth"
    ...
    @Test
    fun testGetTrendingPoolsOnNetwork() {
        val network = "eth"
        val include = "base_token,quote_token"
        val page = 1
    ...
    @Test
    fun testGetMultiplePoolsOnNetwork() {
        val network = "eth"
    ...
    @Test
    fun testGetLatestPoolsOnNetwork() {
        val network = "eth"
        val include = "base_token,quote_token"
        val page = 1
    ...
    @Test
    fun testGetMultipleTokensOnNetwork() {
        val network = "eth"
        val addresses = "0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2,0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48"
        val include = "top_pools"
    ...
    @Test
    fun testGetRecentlyUpdatedTokensInfo() {
        val include = "network"
